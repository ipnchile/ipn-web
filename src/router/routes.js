export const routes = [
    // --- SECCIÓN INSTITUCIONAL ---
    {
        path: '/',
        name: 'home',
        meta: {"title":"IPN Chile | Iglesia Pentecostal Nazareth","fullTitle":true,"description":"Conozca la Iglesia Pentecostal Nazareth (IPN Chile). Encuentre nuestras iglesias, departamentos, actividades y noticias, y una congregación cercana a usted."},
